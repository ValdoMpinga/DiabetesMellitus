...
def diabetesModelTrainer():
    ...
    email_subject = 'Relatorio do re treino da IA'
    programmers_email = ['valdom@ipvc.pt','mauroluis@ipvc.pt']
    ...
    if bestModelScore > 0.90:
        ...
        email_body = 'A IA de diabetes foi re treinada com sucesso, com uma pontuação de {} %, uma precisão de {} % e perca de {} %'.format(
        ...
        email_body = 'A IA de diabetes foi re treinada, porem sem sucesso, com uma pontuação de {} , uma precisão de {} e perca de {} '.format(
