    ...
    def diabeticFamilyHandler(diabeticFamily):
        try:
            ...
            if(diabeticFamily == DiabeticFamilyEnum.yesExceptParents.value):
                diabeticFamilyObject['diabeteicFamily1'] = 1
                diabeticFamilyObject['diabeteicFamily2'] = 0
                diabeticFamilyObject['diabeteicFamily3'] = 0
                diabeticFamilyObject['diabeteicFamily4'] = 0 
            elif(diabeticFamily == DiabeticFamilyEnum.yesParents.value):
                diabeticFamilyObject['diabeteicFamily1'] = 0
                diabeticFamilyObject['diabeteicFamily2'] = 1
                diabeticFamilyObject['diabeteicFamily3'] = 0
                diabeticFamilyObject['diabeteicFamily4'] = 0
            elif(diabeticFamily == DiabeticFamilyEnum.no.value):
                diabeticFamilyObject['diabeteicFamily1'] = 0
                diabeticFamilyObject['diabeteicFamily2'] = 0
                diabeticFamilyObject['diabeteicFamily3'] = 1
                diabeticFamilyObject['diabeteicFamily4'] = 0
            elif(diabeticFamily == DiabeticFamilyEnum.dontKnow.value):
                diabeticFamilyObject['diabeteicFamily1'] = 0
                diabeticFamilyObject['diabeteicFamily2'] = 0
                diabeticFamilyObject['diabeteicFamily3'] = 0
                diabeticFamilyObject['diabeteicFamily4'] = 1
    ...
    def areYouDiabeticHandler(diabetic):
        try:
            ...
            if(diabetic == AreYouDiabeticEnum.yes.value):
                areYouDiabeticObject['diabetic1'] = 1
                areYouDiabeticObject['diabetic2'] = 0
                areYouDiabeticObject['diabetic3'] = 0
            elif(diabetic == AreYouDiabeticEnum.no.value):
                areYouDiabeticObject['diabetic1'] = 0
                areYouDiabeticObject['diabetic2'] = 1
                areYouDiabeticObject['diabetic3'] = 0
            elif(diabetic == AreYouDiabeticEnum.dontKnow.value):
                areYouDiabeticObject['diabetic1'] = 0
                areYouDiabeticObject['diabetic2'] = 0
                areYouDiabeticObject['diabetic3'] = 1
                
            return areYouDiabeticObject
        except:
            print("Please check if you inserted the right values")
