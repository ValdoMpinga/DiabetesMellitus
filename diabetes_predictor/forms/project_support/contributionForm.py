...
from project_support.models import Contribute
...
class ContributionForm(forms.ModelForm):
    idade = forms.ChoiceField(required=True, choices=SEX_CHOICES, widget=forms.RadioSelect(
    ...
    diabetes = forms.ChoiceField(required=True, choices=DIABETES_CHOICES, widget=forms.RadioSelect(
        attrs={'class': 'Radio' 'form-control'}), initial=1)
